...
``tendril-api-core`` can be installed normally from the Python Package Index.
...
`github releases <https://github.com/tendril-framework/tendril-api-core/releases>`_.
...
``tendril-api-core``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-api-core.git
    $ cd tendril-api-core
    $ pip install -e .
