...
setup(
    name='tendril-api-core',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="Core API Server Infrastructure for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-api-core',
    project_urls={
        'Documentation': 'https://tendril-api-core.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-api-core/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-api-core',
    },
